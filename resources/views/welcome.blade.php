...
@section('content')
    ...
    <section class="py-4 px-6 leading-normal flex flex-col text-center">
        <h2 class="pb-5">Read Dracula Online</h2>
        <h3 class="">Receive emails addressed to you from the characters that lived the experience, right in your inbox!</h3>
        ...
        @include('components.CTA', [
            'btn_text' => 'Free Trail - No Obligation',
            'url' => route('register'),
            'bg_transparent' => false
        ])
    </section>

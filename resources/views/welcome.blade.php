...
@section('content')
    ...
    <section class="py-4 px-6 flex flex-col items-center">
    ...
    <section class="py-4 px-6 leading-normal flex flex-col items-center">
        ...
        <p class="">Want to read Dracula online? Sign up for free and embark on the most incredible reading experience: read the classic gothic novel Dracula at the pace of the story and immerse yourself into the world of the most horrific vampire! </p>
        <p class="">The 1897 Gothic horror classic from Bram Stoker is an epistolary novel; it consists of a collection of diary entries, letters, and other materials written by the characters of the story. From the moment you sign up, you will start receiving by email the pieces that comprise the novel at the pace they were written. You will start experiencing the most fantastic reading immersion you have ever had.</p>
        <p class=""><a href="{{ route('register') }}">Sign up for free now</a>, and the first entry in Jonathan Harker’s journal will be waiting for you in your inbox. Be prepared to get hooked!</p>
    </section>
...
<section class="py-4 px-6 my-1 flex flex-row flex-wrap items-center justify-center w-full content-between">
        @include('components.CTA', [

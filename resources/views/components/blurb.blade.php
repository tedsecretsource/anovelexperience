<div class="max-w-xs px-4 py-2 m-3 flex flex-col items-center bg-black text-gray-100 text-center rounded-md shadow-lg" style="width: 300px; min-height: 300px">
